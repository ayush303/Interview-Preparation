...
import startegy.SearchByAuthorStrategy;
import startegy.SearchByTitleStrategy;
...
public class LibraryManagementDemo {
    public static void main(String[] args) {
        ...
        List<BookCopy> natGeoCopies = library.addItem(ItemType.MAGAZINE, "M001", "National Geographic",
                "NatGeo Society", 3);
